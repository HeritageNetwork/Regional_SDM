...
#StudyAreaPoly <- "E:/mobi_repo_tgh_clean2/Regional_SDM/_data/species/anaxexsu/inputs/model_input/anaxexsu_20190110_121839_studyArea.gpkg"
#sa <- st_read(StudyAreaPoly)


# setwd("E:/mobi_repo_tgh_clean2/Regional_SDM/_data/other_spatial/feature")
# 
# states <- st_read("US_States.shp")
# 
# states_diss <- st_union(states)
# 
# sa <-  states_diss
