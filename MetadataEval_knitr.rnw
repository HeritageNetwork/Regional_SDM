...
Figure 3. Partial dependence plots for the nine environmental variables with the 
...
plot(results_shape)
plot(results_shape, col=colcode, add=T)
plot(studyAreaExtent, add=T, border="red", lwd=1)
plot(referenceBoundaries, add=T, border="gray13", lwd=0.5)
