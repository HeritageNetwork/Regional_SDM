...
\\
\underline{Expert Review}\\
The following is a summary of the reviews by NatureServe Network biologists received to date. Something somethng about 4/5 star reviews versus 3 star, versus 1-2 stars.
\begin{table}[H]
 \small
  \centering
  \begin{tabular}{p{5cm}p{3cm}p{5cm}}
  Star Rating & Reviewing States & Notes \\
  \hline
  \score{4.4}{5} based on X reviews & PA, NY, VA & Some Notes \\
  \hline
\end{tabular}
\end{table}  
\smallskip
