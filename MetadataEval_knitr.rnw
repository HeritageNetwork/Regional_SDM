...
# plot it
qtm(basetiles) + 
  tm_shape(results_shape, name="modeled suitability", simplify = 0.5) + # stream linework
  ...
  tm_shape(aquaPolys) + # waterbodies and NHD polys
    tm_fill(col="prbblty", palette=clrs, legend.show = FALSE) + 
