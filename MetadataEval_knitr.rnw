...
stateBoundPath <- "X:/RegionalSDM/zz_testArea/other_spatial" #path of the state boundaries
...
MapScipanci <- raster("X:/RegionalSDM/zz_testArea/outputs/grids/sciranci.tif")
