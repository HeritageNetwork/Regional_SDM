...
\begin{center}
% <<<<<<< HEAD
<<mapFig, fig.width=7, fig.height=7, include=FALSE, echo=FALSE>>=
par(mar=c(0,0,0,0))
nclr <- 5
...
legend("topleft", legend = rev(c("Low", rep("  |  ", nclr-2), "High")), fill = rev(clrs), border = rev(clrs), cex=0.8, bg = "white")
box()
@
