...
model using all sites as input. Abbreviations used: CP = coastal plain, precip = precipitation, temp = temperature, max = maximum, min = minimum, fresh = freshwater, calc = calcareous.
