...
<<tableOne, results="asis", echo = FALSE>>=
	summ.table <- data.frame(Name=c("Reach groups","BG reaches","PR reaches"), #note how many reache groups (replace poly and EOs, keep EOs/observations?, # length( unique(df.in2$huc12))))
