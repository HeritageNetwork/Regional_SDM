...
\multirow{3}{*}{Species Data} & Presence data quality & \Sexpr{as.character(sdm.modeluse$spdata_dataqual)} & \multirow{3}{*}{\Sexpr{as.character(sdm.modeluse$notes_spdata)}} \\ \cline{2-3}
                              & Absence/Background Data & \Sexpr{as.character(sdm.modeluse$spdata_abs)} & \\ \cline{2-3}
                              & Evaluation Data & \Sexpr{as.character(sdm.modeluse$spdata_eval)} & \\ \hline
\multirow{2}{*}{Environmental Predictors} & Ecological and predictive relevance & \Sexpr{as.character(sdm.modeluse$envvar_relevance)} & \multirow{2}{*}{\Sexpr{as.character(sdm.modeluse$notes_envvar)}} \\ \cline{2-3}
                              & Spatial and temporal alignment & \Sexpr{as.character(sdm.modeluse$envvar_align)} & \\ \hline
\multirow{5}{*}{Modeling Process} & Algorithm choice & \Sexpr{as.character(sdm.modeluse$process_algo)} & \multirow{5}{*}{\Sexpr{as.character(sdm.modeluse$notes_process)}} \\ \cline{2-3}
                              & Sensitivity & \Sexpr{as.character(sdm.modeluse$process_sens)} & \\ \cline{2-3}
                              & Statistical rigor & \Sexpr{as.character(sdm.modeluse$process_rigor)} \\ \cline{2-3}
                              & Performance & \Sexpr{as.character(sdm.modeluse$process_perform)} & \\ \cline{2-3}
                              & Model review & \Sexpr{as.character(sdm.modeluse$process_review)} & \\ \hline
\multirow{3}{*}{Model Products} & Mapped products & \Sexpr{as.character(sdm.modeluse$products_mapped)} & \multirow{3}{*}{\Sexpr{as.character(sdm.modeluse$notes_products)}} \\ \cline{2-3}
                              & Interpretation support products & \Sexpr{as.character(sdm.modeluse$products_support)} & \\ \cline{2-3}
                              & Reproducibility & \Sexpr{as.character(sdm.modeluse$products_repo)} & \\ \hline
                              & Iterative & \Sexpr{as.character(sdm.modeluse$interative)} & \Sexpr{as.character(sdm.modeluse$notes_iterative)} \\ \hline                      
\end{tabular}
\end{table}
