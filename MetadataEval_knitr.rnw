...
# set up plot based on study area extent
...
# plot(spTransform(studyAreaExtent, CRSobj = results_shape@proj4string), add=T, border="red", lwd=0.2) #not plotting study area
