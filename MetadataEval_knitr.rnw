...
<<tableOne, results="asis", echo = FALSE>>=
	summ.table <- data.frame(Name=c("polys","EOs","BG reaches","PR reaches"), #note how many HUC12 (replace poly and EOs, keep EOs/observations?, # length( unique(df.in2$huc12))))
