...
\hangindent=10pt Northeast Regional Distribution Modeling Project. \Sexpr{format(Sys.Date(), "%Y")}. Species distribution model, model validation, and environmental variable importance 
